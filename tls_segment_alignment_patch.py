#!/usr/bin/python3
# see https://github.com/Catfriend1/syncthing-android/issues/370
# and https://github.com/golang/go/issues/29674
  ...
  if hdr[4] == 1:
    ...
    for i in range(0, phnum):
      ...
      if t == 7:
        ...
        if (align < 32):
          print('TLS segment is underaligned, patching from ' + str(align) + ' to 32')
          f.seek(-4, 1)
    ...
    for i in range(0, phnum):
      ...
      if t == 7:
        ...
        print('Found TLS segment with align = ' + str(align))
        if (align < 64):
          print('TLS segment is underaligned, patching from ' + str(align) + ' to 64')
          f.seek(-8, 1)
